...
public class WebObjectFactory implements ServletContextListener {
    ...
    private static MeterServiceFacade serviceFacade = null;

    private static MeterServiceObjectFactory serviceObjectFactory = null;

    public static MeterServiceFacade getServiceFacade() {
