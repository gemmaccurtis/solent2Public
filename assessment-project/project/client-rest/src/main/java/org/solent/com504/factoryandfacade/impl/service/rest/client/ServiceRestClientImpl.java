 ...
 * @author gallenc
 */
public class ServiceRestClientImpl implements MeterServiceFacadeRest {
    ...
    public String getHeartbeat() {
        ...
        MeterReplyMessage replyMessage = response.readEntity(MeterReplyMessage.class);
    ...
    public MeterReplyMessage getParkingMeterConfig() {
        LOG.debug("getParkingMeterConfig called");
        
        Client client = ClientBuilder.newClient(new ClientConfig().register(LoggingFilter.class));
        WebTarget webTarget = client.target(baseUrl).path("getParkingMeterConfig");
