...
<%@page import="org.solent.com504.meter.model.service.MeterServiceFacade"%>
...
<%
    ...
    // accessing service 
    MeterServiceFacade serviceFacade = (MeterServiceFacade) WebClientObjectFactory.getServiceFacade();
